...
async function bootstrap() {
  ...
  app.enableCors({
    origin: process.env.CORS_ORIGIN ? process.env.CORS_ORIGIN.split(',').map(s => s.trim()) : ['http://localhost:4001','https://digital-family-tree-web.vercel.app', 'http://localhost:4002'],
    credentials: true,
